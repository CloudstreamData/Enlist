...
<form:form actionEvent="setting.save" bind="setting">
	<table>
		<tr>
			<th>Orginaztion Name:</th>
			<td><form:input path="orgName" size="40" maxlength="200" /></td>
		</tr>
		<tr>
			<th>Description:</th>
			<td><form:textarea path="orgDesc" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><form:input path="pointName" size="10" maxlength="200" /></td>
		</tr>
		<tr>
			<th nowrap="nowrap">Default Point Value:</th>
			<td><form:input path="defaultPointValue" size="10" maxlength="200" /></td>
		</tr>
		<tr>
